    ...
    public class Stock : INotifyPropertyChanged
    {
        ...
        public DateTime? DividendPayDate
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("DividendPayDate"));
                }
            }
        }
        ...
        public decimal? DividendYield
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("DividendYield"));
                }
            }
        }
        ...
        public decimal? OneYearPriceTarget
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("OneYearPriceTarget"));
                }
            }
        }
        ...
        public decimal? ShortRatio
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("ShortRatio"));
                }
            }
        }
        ...
        public decimal? PegRatio
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("PegRatio"));
                }
            }
        }
        ...
        public DateTime? ExDividendDate
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("ExDividendDate"));
                }
            }
        }
        ...
        public decimal? PriceBook
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("PriceBook"));
                }
            }
        }
        ...
        public decimal? PriceSales
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("PriceSales"));
                }
            }
        }
        ...
        public decimal? ChangeInPercent
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("ChangeInPercent"));
                }
            }
        }
        ...
        public decimal? PreviousClose
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("PreviousClose"));
                }
            }
        }
        ...
        public decimal? ChangeFromYearHigh
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("ChangeFromYearHigh"));
                }
            }
        }
        ...
        public decimal? ChangeFromYearLow
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("ChangeFromYearLow"));
                }
            }
        }
        ...
        public decimal? Ebitda
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("Ebitda"));
                }
            }
        }
        ...
        public decimal? YearlyHigh
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("YearlyHigh"));
                }
            }
        }
        ...
        public decimal? YearlyLow
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("YearlyLow"));
                }
            }
        }
        ...
        public decimal? DailyHigh
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("DailyHigh"));
                }
            }
        }
        ...
        public decimal? DailyLow
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("DailyLow"));
                }
            }
        }
        ...
        public decimal? EpsEstimateNextYear
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("EpsEstimateNextYear"));
                }
            }
        }
        ...
        public decimal? EarningsShare
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("EarningsShare"));
                }
            }
        }
        ...
        public DateTime? LastTradeDate
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("LastTradeDate"));
                }
            }
        }
        ...
        public decimal? DividendShare
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("DividendShare"));
                }
            }
        }
        ...
        public decimal? ChangePercent
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("ChangePercent"));
                }
            }
        }
        ...
        public decimal? BookValue
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChanged(this, new PropertyChangedEventArgs("BookValue"));
                }
            }
        }
